...
var isAdmin = false;
if(isAdmin){
    //Show the navbar code inside this if statement
}
...
var checkTrafficLight = function
    if (color === 'green') {
        alert("Go")
...
//
// message = (success) ? 'Operation Successful': 'Oops, Something went wrong';
//
// console.log(message);
...
//TODO: Write a switch statement that evaluates weather as the condition. Check for "rainy", "sunny", "snow", and a default case.
    ...
    switch (weather) {
        case 'rainy':
            ...
            break;
        case 'sunny' :
            alert("Go to the pool!")
            break;
        case 'snowing' :
            alert("Drink some cocoa!")
            break;
        default:
            alert("have a nice day")
    }
